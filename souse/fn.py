...
font = pygame.font.Font("./souse/fonts/PretendardVariable.ttf", 36)
...
class img:
    def __init__(self):
        self.background  = pygame.image.load("./souse/image/back.png")

        self.deler_1     = pygame.image.load("./souse/image/dealer/enemy-1.png")
        self.deler_2     = pygame.image.load("./souse/image/dealer/enemy-2.png")
        #총_saw
        self.gun_45_saw    = pygame.image.load("./souse/image/gun/saw/gun_45.png")
        self.gun_90_saw    = pygame.image.load("./souse/image/gun/saw/gun_90.png")
        self.gun_fire1_saw = pygame.image.load("./souse/image/gun/saw/gun_fire1.png")
        self.gun_fire2_saw = pygame.image.load("./souse/image/gun/saw/gun_fire2.png")
        self.gun_fire3_saw = pygame.image.load("./souse/image/gun/saw/gun_fire3.png")
        self.gun_fire4_saw = pygame.image.load("./souse/image/gun/saw/gun_fire4.png")
        #총 
        self.gun_45       =  pygame.image.load("./souse/image/gun/nomal/gun_45.png")
        self.gun_90       =  pygame.image.load("./souse/image/gun/nomal/gun_90.png")
        self.gun_fire1    =  pygame.image.load("./souse/image/gun/nomal/gun_fire1.png")
        self.gun_fire2    =  pygame.image.load("./souse/image/gun/nomal/gun_fire2.png")
        self.gun_fire3    =  pygame.image.load("./souse/image/gun/nomal/gun_fire3.png")
        self.gun_fire4    =  pygame.image.load("./souse/image/gun/nomal/gun_fire4.png")


        #아이템
        self.cylinder    = pygame.image.load("./souse/image/item/cylinder.png")
        self.doll        = pygame.image.load("./souse/image/item/doll.png")
        self.gift        = pygame.image.load("./souse/image/item/gift.png")
        self.glasses     = pygame.image.load("./souse/image/item/glasses.png")
        self.jusagi      = pygame.image.load("./souse/image/item/jusagi.png")
        self.phone       = pygame.image.load("./souse/image/item/phone.png")
        self.pill        = pygame.image.load("./souse/image/item/pill.png")
        self.saw         = pygame.image.load("./souse/image/item/saw.png")
        self.smoke       = pygame.image.load("./souse/image/item/smoke.png")
        self.sugap       = pygame.image.load("./souse/image/item/sugap.png")
        self.tmp_img     = pygame.image.load("./souse/image/item/tmp.png")
        self.white       = pygame.image.load("./souse/image/item/white.png")
        #하트   
        self.heart_break = pygame.image.load("./souse/image/heart/heart0.png")
        self.heart       = pygame.image.load("./souse/image/heart/heart1.png")
        #탄약   
        self.real        = pygame.image.load("./souse/image/shell/real.png")
        self.fake        = pygame.image.load("./souse/image/shell/fake.png")        
        #기타   
        self.light       = pygame.image.load("./souse/image/light.png")
        self.dot         = pygame.image.load("./souse/image/dot.png")
        self.item_box    = pygame.image.load("./souse/image/item_box.png")
        self.gift_box    = pygame.image.load("./souse/image/gift_box.png")
        #글자
...
def Use_itme(character:Character, slot: int):
    ...
    if item_name == " ":
        return
    elif item_name == "sugap" and opponent.issugap:
        character.item[slot] = item_name
        return
...
def doll():
    if gun.shell[-1]:
        sound = pygame.mixer.Sound('./souse/sound/dryfire.WAV')
...
def phone(character:Character):
    ...
    if character.Name=='Player':
        ...
        realORfake = "실탄" if gun.shell[-1] else "공탄"
        t =font.render(f'{n}번째 탄 {realORfake}이야..', True, (10,10,10))
        screen.blit(t, (907,330))
        pygame.display.update((907,330,907+t.get_height(),330+t.get_width()))
        time.sleep(3)
    else:
...
def determine():
    ...
    if not len(dealer.expected_shell):
        return 0    
    elif dealer.expected_shell[-1] != -1:
        possibility = dealer.expected_shell[-1]
    else:
    ...
    if gun.shell[-1]:
        for i in fire_img_arr:
            ...
            if game.isPlayerTurn:
                ...
                if isnt_self_shot:
                    screen.blit(i, (856,-300))
                else:
                    screen.blit(i, (856,-500))
